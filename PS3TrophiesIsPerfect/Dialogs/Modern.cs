...
namespace PS3TrophiesIsPerfect.Dialogs
{
    ...
    public static class Modern
    {
        ...
        public static async Task<bool> Confirm(string message, string title, string yes = "Yes", string no = "Cancel")
        {
        ...
        public static async Task<string> PromptNpsso()
        {
            ...
            {
                Text = "Your games and trophies come straight from PlayStation. To connect, paste a one-time "
            ...
            panel.Children.Add(Step("3.", "Copy the 64-character value after \"npsso\" and paste it below."));
        ...
        private static StackPanel Step(string number, string text)
        {
            ...
            row.Children.Add(new TextBlock { Text = number, FontWeight = FontWeights.SemiBold, Margin = new Thickness(0, 0, 8, 0) });
        ...
        public static async Task<DateTime?> PromptDate(string title, DateTime initial, bool showTime)
        {
            ...
            return new DateTime(date.Year, date.Month, date.Day,
                Clamp(hour.Text, 0, 23), Clamp(min.Text, 0, 59), Clamp(sec.Text, 0, 59));
        }
        ...
        {
            var b = new TextBox { Text = value.ToString("00"), Width = 44, MaxLength = 2, Margin = new Thickness(8, 0, 0, 0) };
            ControlHelper.SetPlaceholderText(b, placeholder);
            return b;
        }

        private static TextBlock Colon() =>
            new TextBlock { Text = ":", VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(3, 0, 0, 0) };
